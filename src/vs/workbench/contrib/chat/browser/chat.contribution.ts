...
import { ChatMessageUrlHandler } from './chatMessageUrlHandler.js';
...
registerWorkbenchContribution2(ChatMessageUrlHandler.ID, ChatMessageUrlHandler, WorkbenchPhase.AfterRestored);
